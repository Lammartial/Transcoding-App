...
"	border-radius: 150px;\n"
"	background-color: qconicalgradient(cx:0.5, cy:0.5, angle:90, stop:0.749 rgba(255, 0, 127, 0), stop:0.750 rgba(254, 121, 199, 255));\n"
"}")
...
"	border-radius: 150px;\n"
"	background-color: rgba(122, 161, 210, 250); \n"
"}")
...
"	border-radius: 10px;	\n"
"	background-color: rgb(229, 93, 135);\n"
"	color: #FFFFFF;\n"
"	margin-left: 40px;\n"
"	margin-right: 40px;\n"
"}")
...
"color: rgb(155, 155, 255);")
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.labelTitle.setText(QCoreApplication.translate("SplashScreen", u"<html><head/><body><p><span style=\" font-weight:600; color:#e55d87;\">TRANSCODING </span>APP</p></body></html>", None))
        ...
        self.labelCredits.setText(QCoreApplication.translate("SplashScreen", u"by: Miniteam - v1.0.0", None))
    # retranslateUi
